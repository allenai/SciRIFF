...
TEMPLATE_ATTRIBUTES = {
    "Glass_Compound_Amount": ["value", "type", "constituent", "unit", "material"],
    "Other": ["value", "type"]
}

class Formatter:
    """
    Formatter for DisCoMat Dataset in the Schema-to-JSON benchmark
    """
    def format_instance(self, instance):
        ...
        for each_record in instance["gold_json_records"]["cell_record"]:
            ...
            cell_record_str = json.dumps(cell_record_processed)
