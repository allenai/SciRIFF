...
TEMPLATE_ATTRIBUTES = {
    "IC50": ["value", "type", "unit", "treatment", "target"],
    "EC50": ["value", "type", "unit", "treatment", "target"],
    "CC50": ["value", "type", "unit", "treatment", "target"],
    "MIC": ["value", "type", "unit", "treatment", "target"],
    "GI50": ["value", "type", "unit", "treatment", "target"],
    "Other": ["value", "type"]
}

class Formatter:
    """
    Formatter for ChemTables Dataset in the Schema-to-JSON benchmark
    """
